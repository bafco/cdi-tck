...
public class PriorityInvocationOrderTest extends AbstractTest {

    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(PriorityInvocationOrderTest.class).build();
    }
    ...
    public void testInvocationOrder() {
        ...
        getContextualReference(MyBean.class).myMethod();
        assertSequenceEquals(
                SuperInterceptor0.class, Interceptor0.class,
                SuperInterceptor12.class, Interceptor1.class,
                SuperInterceptor12.class,
                SuperInterceptor12.class, Interceptor2.class,
                MyBean.class);
    }
